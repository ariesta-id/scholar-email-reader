...
def get_article(html_body):
    ...
    for title_link in title_links:
        try:
            ...
            abstract = (
                abstract_div.get_text(strip=True).replace("<br>", "\n")
                if abstract_div
                else ""
            )
                ...
                try:
                    ...
                    if html_body:
                        ...
                        for article in articles:
                            classification_result = classify_article_relevance(
                                article["title"], article["abstract"]
                            )
                            relevance = classification_result[0]
                            probability = classification_result[1]
                            prompt_tokens = classification_result[2]
                            completion_tokens = classification_result[3]
